    ...
    public class HowTosController : Controller
    {
            ...
            Highcharts chart = new Highcharts("chart")
                ...
                .SetSeries(new[]
                {
                    ...
                    new Series
                    {
                        Data =
                            new Data(new object[]
                            {176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4, 29.9, 71.5, 106.4, 129.2, 144.0}),
                        PlotOptionsSeries = new PlotOptionsSeries
                        {
        ...
        public ActionResult DisableAnimation()
        {
            Highcharts chart = new Highcharts("chart")
                ...
                {
                    Data =
                        new Data(new object[] { 29.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4 })
                });
            return View(chart);
        }
            ...
            Highcharts chart = new Highcharts("chart")
                ...
                .SetPlotOptions(new PlotOptions
                {
                    Column =
                        ...
                        {
                            Animation =
                                new Animation(new AnimationConfig { Duration = 2000, Easing = EasingTypes.EaseOutBounce })
                        }
                })
                .SetXAxis(new XAxis
                {
        ...
        public ActionResult UseDotNetGlobalization()
        {
            Highcharts chart = new Highcharts("chart")
                ...
                {
                    Lang = new Lang().SetAndUseCulture("de-DE"),
                ...
                .SetSeries(new Series
                {
                    ...
                    Data =
                        new Data(new object[]
                        {
                            8929.9, 9071.5, 7106.4, 10129.2, 8144.0, 8176.9, 7135.6, 9148.5, 10216.4, 8194.1, 8995.6,
                            7754.4
                        })
                });
            return View(chart);
        ...
        public ActionResult MapDataToHeatMap()
        {
            ...
            // xAxisCategories
            string[] xAxisCategories = { "Alexander", "Marie", "Maximilian", 
                                           "Sophia", "Lukas", "Maria", "Leon", "Anna", "Tim", "Laura" };

            // yAxisCategories
            string[] yAxisCategories = { "Monday", "Tuesday", "Wednesday", 
                                           "Thursday", "Friday" };
            ...
            Highcharts chart = new Highcharts("chart")
                ...
                .SetPlotOptions(new PlotOptions
                {
                    // the plotoptions for heatmap WILL create labels in the blocks
                    Heatmap = new PlotOptionsHeatmap
                    {
                        BorderWidth = 0,
                        DataLabels = new PlotOptionsHeatmapDataLabels
                        {
                            Enabled = true,
                            Color = Color.Black
                        },
                        Events = new PlotOptionsHeatmapEvents
                        {
                            Click = "function(event) {alert('the element was clicked!');}"
                        }
                    }
                ...
                {
                    Min = 0,
                    MinColor = ColorTranslator.FromHtml("#FFFFFF"),
                    MaxColor = Color.FromName("Highcharts.getOptions().colors[0]"),
                })
                .SetTooltip(new Tooltip
                {
                    Formatter = @"
